...
const renderItem = ({ item }: { item: NewsDTO }) => (
  <CardNew data={item} handleGoToNewsDetails={(newData: NewsDTO) => {}} />
);
...
export const News = () => {
  ...
  const { newsData, isEnd } = useSelector(({ news }: IRootState) => news);
